...
{{< hackcss-form name="validate" action="validate/" >}}
  {{< hackcss-formgroup name="integrity" >}}
    ...
    >}}
    {{< hackcss-helpblock >}}
      Submit with 10.1.0 <a href="/feature/release-hashes">Release Hash</a> to validate.
...
<script>
  (function (window, document, undefined) {
    "use strict";
    const digest = 'hLJOM59VpuR/jP4qyJDxxsYCc0cJwvJvuqaSs35cmNN2TVLXEAXjj6XkrZtUcxjxO+nx6Fgqnse88KKUAPreuw==';
    const confirm = form => {
